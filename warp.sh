...
apt-get install qrencode wireguard-tools wget -y

curl -o wgcf https://download.scholar.rr.nu/ViRb3/wgcf/releases/download/v2.2.22/wgcf_2.2.22_linux_amd64
chmod +x ./wgcf

./wgcf

curl https://gitlab.com/Misaka-blog/warp-script/-/raw/main/files/warp-yxip/warp-yxip.sh | bash
